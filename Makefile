...
SRC = ft_printf.c ft_write_c.c ft_write_d.c ft_write_i.c ft_write_p.c ft_write_per.c ft_write_s.c ft_write_u.c ft_write_lowerx.c ft_write_upperx.c check_flag.c check_precision.c check_specifier.c check_width.c process_raw_str.c collect_format.c print_res_str.c
OBJ = ft_printf.o ft_write_c.o ft_write_d.o ft_write_i.o ft_write_p.o ft_write_per.o ft_write_s.o ft_write_u.o ft_write_lowerx.o ft_write_upperx.o check_flag.o check_precision.o check_specifier.o check_width.o process_raw_str.o collect_format.o print_res_str.o
BONUS_SRC = 
BONUS_OBJ = 
