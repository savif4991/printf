...
SRC = ft_printf.c ft_write_c.c ft_write_d.c ft_write_i.c ft_write_p.c ft_write_per.c ft_write_s.c ft_write_u.c ft_write_lowerx.c ft_write_upperX.c
OBJ = ft_printf.o ft_write_c.o ft_write_d.o ft_write_i.o ft_write_p.o ft_write_per.o ft_write_s.o ft_write_u.o ft_write_lowerx.o ft_write_upperX.o
BONUS_SRC = 
BONUS_OBJ = 
